...
const STEPS = [
    ...
    details: [
      {
        ...
        steps: ['Safari 하단 공유 버튼(□↑) 탭', '"홈 화면에 추가" 선택', '우측 상단 "추가" 탭'],
      },
      {
  ...
  },
  {
    ...
    bullets: [
      ...
      '30페이지씩 자동 분할 처리되며, 오류 발생 시 "이어서 처리하기"가 가능해요.',
  ...
  },
  {
    ...
    tab: 'study' as const,
    bullets: [
      '🖍️ 중요한 지문은 노랑/초록/핑크 형광펜으로 칠해보세요 (오답노트에 연동).',
      '형광펜을 다시 클릭하면 🧹 지우개 커서로 바로 지울 수 있어요.',
      'ㄱㄴㄷㄹ 항목별로 정오 표시와 개별 메모를 작성할 수 있어요.',
