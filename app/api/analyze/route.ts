...
각 항목 형식: {"문제번호": number, "연도": number, "단원": string, "지문": string, "선지": {"①": string, "②": string, "③": string, "④": string,"⑤": string}, "정답": string, "해설": string|null, "선지별설명": {"①": string, "②": string, "③": string, "④": string, "⑤": string}|null, "보기목록": [{"label": string, "text": string, "isCorrect": boolean, "explanation": string}]|null}
